...
```
in the kindnet logs, you may need to add the KUBERNETES_SERVICE_HOST as an environment to the kindnet DaemonSet and set it to the URL of the public API endpoint. 
